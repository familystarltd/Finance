...
namespace Finance.Web.Data
{
    ...
    {
        #region COMPANY
        IEnumerable<Business> GetCompanies();
        IEnumerable<Business> GetCompanies(string Service);
    ...
    public class BusinessRepository: IBusinessRepository
    {
        ...
        #region COMPANY
        public IEnumerable<Business> GetCompanies()
        {
            try
            {
        ...
        public IEnumerable<Business> GetCompanies(string Service)
        {
            try
            {
    ...
    public class BusinessDbContext : DbContext, IQueryableUnitOfWork
    {
        ...
        public BusinessDbContext(DbContextOptions<ApplicationDbContext> options) :base(options)
        {
