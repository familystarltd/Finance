...
namespace Finance.Domain.Aggregates.FinancialTransactionAgg
{
    public class CreditNote : FinancialTransaction
    {
        ...
        //public virtual Invoice Invoice { get { if (invoice != null) {  invoice.CreditNotes = null; } return invoice; } set { invoice = value; } }
        /// <summary>
        ...
        //public virtual Receipt Receipt { get { if (receipt != null) { receipt.CreditNote = null; receipt.CreditNotes = null; } return receipt; } set { receipt = value; } }
        /// <summary>
        ...
        public decimal CreditAvailable {
            get {
                return Receipts == null || Receipts.Count == 0 ? this.Amount : this.Amount - Receipts.Sum(r => r.TransactionStatus == FinancialTransactionAgg.TransactionStatus.Void ? 0 : r.Amount);
                //return 0;
            }
        }
    }
