...
namespace Finance.Application.Service
{
    public interface IInvoiceAppService
    {
        ...
        IEnumerable<InvoiceModel> GetInvoices(string PayerName, string CustomerName, int CustomerNo, DateTime? InvoiceFromDate, DateTime? InvoiceToDate, int pageIndex, int pageSize, out int TotalRowCount);
        ...
        IEnumerable<InvoiceModel> GetInvoicesForPayment(Guid PayerId, DateTime ReceiptDate);
