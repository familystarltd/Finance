...
namespace FinanceManagement.Application.Service
{
    public class InvoiceAppService : IInvoiceAppService
    {
        ...
        {
            Calendar calendar = new Calendar(FinanceManagement.Application.Service.Settings.AppSetting.BankHolidayOfflineSourceFile);
            int weekdays = 0;
            int saturdays = 0;
            int sundays = 0;
            int bankHolidays = 0;
            ...
            {
                case FinanceManagement.Domain.Aggregates.FeeAgg.DayPremium.Weekday:
                    ...
                    if (invoiceDetail.NoOfDays > 0 && hourlyRate.NoOfHours > 0 && hourlyRate.RateAmount > 0)
                    {
                        ...
                        {
                            case FinanceManagement.Domain.Aggregates.FeeAgg.TimePremium.Day:
                                ...
                                break;
                            case FinanceManagement.Domain.Aggregates.FeeAgg.TimePremium.Night:
                    ...
                    break;
                case FinanceManagement.Domain.Aggregates.FeeAgg.DayPremium.Weekend:
                    ...
                    break;
                case FinanceManagement.Domain.Aggregates.FeeAgg.DayPremium.Bankholiday:
            ...
            try
            {
                ...
                try
                {
                    ...
                    foreach (Fee fee in fees)
                    {
                        ...
                        {
                            case FinanceManagement.Domain.Aggregates.FeeAgg.PaymentTerm.Monthly:
                                feeFromDate = FromDate;
                                feeToDate = ToDate;
                                IsValidFeeTerm = true;
                                break;
                            case FinanceManagement.Domain.Aggregates.FeeAgg.PaymentTerm.FourWeely:
                        ...
                        invoice.InvoiceStatus = FinanceManagement.Domain.Aggregates.FinancialTransactionAgg.InvoiceStatus.Draft;
        ...
        public IEnumerable<InvoiceModel> GetInvoices(Web.Model.InvoiceStatus invoiceStatus, DateTime? InvoiceFromDate, DateTime? InvoiceToDate, int pageIndex, int pageSize, out int TotalRowCount)
        {
            try
            {
                ...
                {
                    case FinanceManagement.Web.Model.InvoiceStatus.New:
                        return this._InvoiceRepository.GetInvoices(FinanceManagement.Domain.Aggregates.FinancialTransactionAgg.InvoiceStatus.Draft, InvoiceFromDate, InvoiceToDate, pageIndex, pageSize, out TotalRowCount).ProjectedToCollection<InvoiceModel>();
                    case FinanceManagement.Web.Model.InvoiceStatus.Void:
                        return this._InvoiceRepository.GetInvoices(FinanceManagement.Domain.Aggregates.FinancialTransactionAgg.InvoiceStatus.Void, InvoiceFromDate, InvoiceToDate, pageIndex, pageSize, out TotalRowCount).ProjectedToCollection<InvoiceModel>();
                    case FinanceManagement.Web.Model.InvoiceStatus.Cancel:
                        return this._InvoiceRepository.GetInvoices(FinanceManagement.Domain.Aggregates.FinancialTransactionAgg.InvoiceStatus.Cancel, InvoiceFromDate, InvoiceToDate, pageIndex, pageSize, out TotalRowCount).ProjectedToCollection<InvoiceModel>();
                    case FinanceManagement.Web.Model.InvoiceStatus.Approved:
                        return this._InvoiceRepository.GetInvoices(FinanceManagement.Domain.Aggregates.FinancialTransactionAgg.InvoiceStatus.Approved, InvoiceFromDate, InvoiceToDate, pageIndex, pageSize, out TotalRowCount).ProjectedToCollection<InvoiceModel>();
                    case FinanceManagement.Web.Model.InvoiceStatus.Paid:
                        return this._InvoiceRepository.GetInvoices(FinanceManagement.Domain.Aggregates.FinancialTransactionAgg.InvoiceStatus.Paid, InvoiceFromDate, InvoiceToDate, pageIndex, pageSize, out TotalRowCount).ProjectedToCollection<InvoiceModel>();
                }
        ...
        public InvoiceModel UpdateInvoiceStatus(int InvoiceNo, Web.Model.InvoiceStatus invoiceStatus)
        {
            try
            {
                ...
                invoice.InvoiceStatus = Mapper.Map<FinanceManagement.Domain.Aggregates.FinancialTransactionAgg.InvoiceStatus>(invoiceStatus);
                this._InvoiceRepository.UnitOfWork.Commit();
